...
METADATA_URL="${METADATA_URL:-s3://958825666686-dpservices-testing-data/conductor-poc/Reverse_Email_Json/1000860417.Reverse_Email.append.json}"
EXECUTION_ID="${EXECUTION_ID:-WBReverseEmail_Append}"
DAG_ID="${DAG_ID:-nua-append-process-stage-v01-01-02-tiny}"
...
# Optional STATS_URL
STATS_URL="${STATS_URL:-scp://abinitio@papdpsetld003l.intra.infousa.com//abi/log/UQU_1001013123.7582.stats.jsonl}"
...
# Logs
echo "Triggering APPEND DAG: ${DAG_ID}" >&2
echo "Job ID: ${JOBID}" >&2
